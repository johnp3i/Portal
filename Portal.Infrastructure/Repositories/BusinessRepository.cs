...
public class BusinessRepository : GenericStoredProcedureRepository<Business>
{
    ...
    public async Task<List<Business>> GetAllAsync()
    {
        try
        {
            const string query = "SELECT [Id], [Name], [IsActive], [IsDemoAccount], [CreatedAtUtc], [UpdatedAtUtc] FROM [portal].[Business]";
    ...
    public async Task<Business?> GetByIdAsync(int id)
    {
        try
        {
            const string query = "SELECT [Id], [Name], [IsActive], [IsDemoAccount], [CreatedAtUtc], [UpdatedAtUtc] FROM [portal].[Business] WHERE [Id] = @Id";
