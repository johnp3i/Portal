...
// Feature: invoice-edit-modal-lines, Property 4: Reverse charge sets VAT to 0 readonly, uncheck restores previous value

/// <summary>
/// Property-based tests for the reverse charge toggle behavior in invoice-line-modal.js.
...
/// </summary>
public class InvoiceReverseChargeTogglePropertyTests
{
    /// <summary>
    /// Represents the state of the VAT input field in the Invoice Line Item Modal.
    ...
    /// Mirrors the JS logic in invoice-line-modal.js:
    ...
    /// <summary>
    /// Property 4a: For any initial VAT rate, checking the Reverse Charge checkbox
    /// SHALL set VAT to 0 and make it read-only.
    ...
    /// <summary>
    /// Property 4b: For any initial VAT rate, checking then unchecking the Reverse Charge
    ...
    /// <summary>
    /// Property 4c: Multiple toggle cycles preserve correctness — toggling on/off N times
