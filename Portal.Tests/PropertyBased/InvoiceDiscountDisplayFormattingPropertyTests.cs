...
// Feature: invoice-edit-modal-lines, Property 2: Zero discount shows dash, positive shows minus-prefixed currency amount

/// <summary>
/// Property-based tests for discount display formatting in the invoice line item table.
...
/// </summary>
public class InvoiceDiscountDisplayFormattingPropertyTests
{
    #region Helper: Discount Display Logic (Oracle)

    /// <summary>
    /// Replicates the discount amount computation from the Invoice Edit view:
    ...
    /// <summary>
    /// Replicates the discount display formatting from the Invoice Edit view:
    /// If discountAmount == 0 → "-"
