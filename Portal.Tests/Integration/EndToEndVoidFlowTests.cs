...
public class EndToEndVoidFlowTests
{
    ...
    public async Task VoidPayment_EndToEnd_RestoresInvoiceToOriginalState()
    {
        ...
        try
        {
            ...
            var paymentService = new PaymentService(paymentRepo, invoiceRepo, creditNoteRepo, financialStatusEngine, new Mock<IPaymentScheduleService>().Object, new Mock<IPaymentAllocationEngine>().Object, dbContext);
