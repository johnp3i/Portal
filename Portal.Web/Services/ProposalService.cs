...
public class ProposalService : IProposalService
{
    ...
    public async Task<ProposalShare> ShareAsync(int quotationId, DateTimeOffset expiresAtUtc, List<int> heroLogoIds, int? metaLogoId, string userId)
    {
        ...
        if (string.IsNullOrWhiteSpace(customer.Email))
            throw new ArgumentException("Customer email is required for sharing a proposal.");
        ...
        // Send email notification (failure doesn't roll back the share)
        try
        {
