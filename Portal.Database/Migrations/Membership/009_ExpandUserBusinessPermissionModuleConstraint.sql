-- ============================================================
-- Migration 009: Expand UserBusinessPermission Module CHECK constraint
-- ============================================================
-- Purpose: Adds all new modules to the CHECK constraint on
--          [membership].[UserBusinessPermission] so user permissions
--          can include: sales, attachments, purchase_import, zreport_import,
--          recurring_expense_validation, payment_link_manual, payment_link_auto,
