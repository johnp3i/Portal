...
- [x] 2. Repository layer
  ...
  - [x] 2.2 Create RevenueSummaryRepository
...
- [ ] 3. Service layer — RevenueSummaryService
  - [x] 3.1 Create IRevenueSummaryService interface and RevenueSummaryService class
  ...
  - [x] 3.2 Implement Revenue Source CRUD methods
  ...
  - [x] 3.3 Implement Revenue Summary validation and computation
  ...
  - [x] 3.4 Implement VAT period assignment logic
  ...
  - [x] 3.5 Implement Revenue Summary CRUD methods
  ...
  - [x] 3.6 Implement VAT integration and dashboard methods
...
- [x] 5. View models and controller
  - [x] 5.1 Create view models
  ...
  - [x] 5.2 Create ZReportController with page actions
  ...
  - [x] 5.3 Create ZReportController AJAX endpoints
...
- [x] 6. Razor views — Z-Reports list and forms
  - [x] 6.1 Create Z-Reports list page (Index.cshtml)
  ...
  - [x] 6.2 Create Z-Report form page (Create.cshtml / Edit.cshtml — shared partial or single view with mode)
  ...
  - [x] 6.3 Create Revenue Sources management page (Sources.cshtml)
...
- [x] 7. Client-side JavaScript — auto-computation and form interactions
  - [x] 7.1 Create `wwwroot/js/zreport-form.js`
  ...
  - [x] 7.2 Create `wwwroot/js/zreport-list.js`
  ...
  - [x] 7.3 Create `wwwroot/js/revenue-sources.js`
...
- [x] 8. Checkpoint — Core Z-Report functionality
...
- [x] 9. Feature toggle and navigation integration
  - [x] 9.1 Add IsZReportEnabled toggle to MyBusiness settings page
  ...
  - [x] 9.2 Update sidebar navigation — conditional Z-Reports menu item
...
- [ ] 10. VAT integration
  - [x] 10.1 Extend VatSubmissionService — Output VAT contribution
  ...
  - [x] 10.2 Extend VAT Period Report — Z-Reports section
  ...
  - [x] 10.3 Extend VAT Detail page — Z-Reports section
...
- [x] 11. Revenue Dashboard integration
  - [x] 11.1 Extend DashboardService — include Z-Report revenue
...
- [x] 12. Document Attachment integration
  - [x] 12.1 Wire existing Document Attachment partial to Z-Report Edit page
...
- [ ] 13. Tenant isolation enforcement
  - [x] 13.1 Verify tenant isolation across all endpoints
...
- [x] 14. Subscription tier gating
  - [x] 14.1 Verify subscription access controls
